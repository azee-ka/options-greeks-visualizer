...
function BlackScholesDeepSection() {
    return (
      <div className="space-y-8">
        <div>
          <h1 className="text-5xl font-bold text-white mb-4 flex items-center gap-4">
...
function GreeksExplainedSection() {
    return (
      <div className="space-y-8">
        <div>
          <h1 className="text-5xl font-bold text-white mb-4 flex items-center gap-4">
...
function PricingDynamicsSection() {
return (
<div className="space-y-8">
<div>
  <h1 className="text-5xl font-bold text-white mb-4 flex items-center gap-4">
...
function TutorialSpreadsSection() {
return (
<div className="space-y-8">
<div>
  <h1 className="text-5xl font-bold text-white mb-4 flex items-center gap-4">
...
function TutorialVolatilitySection() {
return (
<div className="space-y-8">
<div>
  <h1 className="text-5xl font-bold text-white mb-4 flex items-center gap-4">
...
function AdvancedSection() {
  ...
  function StrategiesDeepSection() {
    return (
      <div className="space-y-8">
        <div>
          <h1 className="text-5xl font-bold text-white mb-4 flex items-center gap-4">
